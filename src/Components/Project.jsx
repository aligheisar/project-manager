...
let Project = () => {
  ...
  return (
    <section className="project-container custom-scroll mx-auto flex h-full w-3/4 flex-col overflow-x-hidden bg-background-color transition-colors max-lg:w-full">
      {currentProject ? (
        <>
